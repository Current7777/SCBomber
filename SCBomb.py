...
##########################################################
# DEV : Current7777
# Github : https://github.com/Current7777

# I am completely destroyed. 304 Not Modified.,,
...
try:
  ...
  if maoversys:
    exit("\n{acl}[ {rcl}FILEFILE ERROR TYPE : {acl}]{ycl}  {emao} {acl}[ {rcl}!{acl} ]{ncl}\n".format(acl=acl,rcl=rcl,ycl=ycl,ncl=ncl,emao=emao))
  else:
...
os.system('clear')
agents = user_agent
def autherCurrent7777():
  os.system('xdg-open https://github.com/Current7777')
